...
export class PmgmApiClient {
  ...
  async uploadSecretariatCeremonyAuthorizationPdf(ceremonyRequestId: string, description: string, file: File): Promise<SecretariatDocument> {
    ...
    return this.putSecretariatPdf(`/api/gran-secretaria/ceremonias/${encodeURIComponent(ceremonyRequestId)}/autorizacion-pdf`,file,{ 'X-Document-Description':description,'X-Physical-Signatures-Confirmed':'true' })
  }
