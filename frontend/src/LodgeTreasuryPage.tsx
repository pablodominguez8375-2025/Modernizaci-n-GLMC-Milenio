...
export default function LodgeTreasuryPage({api,canManage,canApproveExpenses}:{api:PmgmApiClient;canManage:boolean;canApproveExpenses:boolean}){
 ...
 {organizationId&&section!=='statement'&&<LodgeTreasuryPanel api={api} organizationId={organizationId} canManage={canManage} canApproveExpenses={canApproveExpenses} section={section}/>} 
