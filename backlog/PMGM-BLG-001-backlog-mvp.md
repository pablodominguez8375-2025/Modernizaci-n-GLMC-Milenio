...
- ✅: incremento implementado y validado en `dev`.
...
- P0 — PMGM-BLG-048 Cumplimiento Ley 21.719. En ejecución avanzada.
- P0 — inventario de actividades de tratamiento y finalidades. ✅ baseline ingeniería
- P0 — clasificación de datos personales/sensibles. ✅ catálogos + gate
- P0 — privacidad por diseño y por defecto. ✅ baseline ingeniería
- P0 — política de conservación, anonimización y supresión. En ejecución avanzada.
- P0 — flujo de derechos de titulares. ✅
- P0 — gestión de incidentes de privacidad/seguridad. ✅
- P0 — gate de privacidad previo a producción. Parcial: gates de ingeniería activos; revisión legal final pendiente.
...
- P1 — conservación diferenciada por finalidad y base jurídica. En ejecución.

### Régimen Interior
- P1 — expediente institucional consolidado.
- P1 — reportes por Orden y Taller. ✅
- P1 — activos/inactivos/retiros/reintegros/defunciones. ✅
- P1 — consistencia histórica. ✅ núcleo
- P1 — elegibilidad explicable para ceremonias y reconocimientos. ✅
- P1 — tablero ejecutivo. ✅ resumen agregado
- P1 — acceso a datos sensibles estrictamente por finalidad y alcance. ✅ baseline

### Gran Secretaría
- P1 — decretos, comunicados y circulares. ✅
- P1 — plantillas y correlativos. ✅ núcleo
- P1 — autorizaciones de iniciación, aumento de salario y exaltación. ✅
- P1 — gestión de templos y salas. ✅
- P1 — calendario institucional de espacios. ✅ disponibilidad/reservas
...
- P1 — excepciones formales y auditadas. ✅ núcleo
- P1 — publicación previa del insinuado en iniciaciones. ✅
- P1 — plazo mínimo configurable; valor inicial 20 días. ✅ motor/configuración
...
### Gestión Logial
- P1 — Tenidas. ✅ PMGM-BLG-049
- P1 — Asistencia y excusas. ✅ append-only, PMGM-BLG-049
- P1 — Actas versionadas. ✅ PMGM-BLG-049
- P2 — Planchas vinculadas a Tenidas.
- P2 — orden del día estructurado e invitados/visitantes.
...
- P0 — inventario de encargados/proveedores con acceso a datos. ✅ núcleo privacidad
- P0 — inventario de transferencias internacionales de datos. ✅ núcleo privacidad
- P1 — soporte a EIPD/DPIA para tratamientos de alto riesgo. ✅ núcleo privacidad

## Orden recomendado de implementación
1. Fundación, BD, Docker y CI. ✅
2. SSO/RBAC/auditoría. ✅
3. Ley 21.719: inventario, clasificación, finalidad/base jurídica, conservación y gate de privacidad. En ejecución avanzada.
...
11. Derechos de titulares, incidentes, proveedores y transferencias internacionales. ✅ núcleo; revisión legal pendiente
12. Dashboard e intranet. ✅
13. Gestión Logial y documentación. ✅ núcleo Tenidas/Asistencia/Actas
14. Gestor Documental + Biblioteca Virtual. Siguiente incremento recomendado.
...
20. crear y cerrar una Tenida dentro del Taller autorizado;
21. registrar y rectificar asistencia conservando el evento histórico anterior;
22. crear y aprobar versiones sucesivas de un acta sin sobrescribir versiones históricas;
23. impedir que órganos con alcance de Orden accedan automáticamente a actas/asistencia de Taller cuando su función no lo requiere.
