...
CATALOGS = [
    ...
    Path("docs/seguridad/PMGM-DATA-CLASSIFICATION-LODGE-SECRETARIAT.json"),
    ...
    Path("docs/seguridad/PMGM-DATA-CLASSIFICATION-GRAND-ARCHIVE.json"),
    Path("docs/seguridad/PMGM-DATA-CLASSIFICATION-BOOTSTRAP.json"),
]
