...
public static class SystemConfigurationEndpoints
{
    private static readonly IReadOnlyDictionary<string, Definition> Definitions = new Dictionary<string, Definition>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["system.permissions.lodge_venerable"] = new("Perfiles y permisos", "Venerable Maestro", "list", "Supervisión general del Taller|Presidir Tenidas y Consejo de Administración|Revisar Tesorería|Revisar Hospitalaria|Firmar actas y documentos aplicables|Aprobar egresos según flujo|Ceremonias"),
        ["system.permissions.lodge_secretariat"] = new("Perfiles y permisos", "Secretaría del Taller", "list", "Ficha administrativa|Tenidas y asistencia|Actas y correspondencia|Insinuados|Solicitudes de ceremonias|Documentos y agenda"),
        ["system.permissions.lodge_treasury"] = new("Perfiles y permisos", "Tesorería del Taller", "list", "Cuotas|Ingresos|Egresos|Morosidad|Estados y rendiciones|Comprobantes"),
        ["system.permissions.lodge_hospitalaria"] = new("Perfiles y permisos", "Hospitalaria del Taller", "list", "Bolso de Hospitalaria|Ayudas y socorros|Reposiciones|Visitas|Estados y rendiciones"),
        ["system.permissions.lodge_orator"] = new("Perfiles y permisos", "Orador del Taller", "list", "Revisión normativa|Actas y extractos|Elecciones, votaciones y escrutinio|Memoria Anual|Retiros y documentos aplicables"),
        ["system.permissions.lodge_first_warden"] = new("Perfiles y permisos", "Primer Vigilante", "list", "Docencia de Compañeros|Cámaras de instrucción|Asistencia|Trabajos|Seguimiento formativo"),
        ["system.permissions.lodge_second_warden"] = new("Perfiles y permisos", "Segundo Vigilante", "list", "Docencia de Aprendices|Cámaras de instrucción|Asistencia|Trabajos|Seguimiento formativo"),
        ["system.permissions.lodge_past_master"] = new("Perfiles y permisos", "Inmediato Ex-Venerable Maestro", "list", "Docencia de Maestros|Cámaras de instrucción|Asistencia|Trabajos|Seguimiento formativo|Consejo de Administración|Subrogación cuando corresponda"),
        ...
        ["system.brand.primary_color"] = new("Identidad visual", "Color institucional principal", "text", "#06148E"),
        ["system.brand.secondary_color"] = new("Identidad visual", "Azul institucional complementario", "text", "#004AD4"),
        ["system.brand.gold_color"] = new("Identidad visual", "Dorado institucional", "text", "#F3C609"),
        ["system.brand.accent_color"] = new("Identidad visual", "Dorado institucional fuerte", "text", "#FBAE17"),
