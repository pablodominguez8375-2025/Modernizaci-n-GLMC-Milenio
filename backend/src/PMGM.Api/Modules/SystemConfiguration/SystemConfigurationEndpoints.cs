...
public static class SystemConfigurationEndpoints
{
    private static readonly IReadOnlyDictionary<string, Definition> Definitions = new Dictionary<string, Definition>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["system.brand.secondary_color"] = new("Identidad visual", "Color institucional secundario", "text", "#F3C609"),
        ["system.brand.logo_reference"] = new("Identidad visual", "Referencia del logotipo oficial", "text", "logo-glmch-oficial.svg"),
