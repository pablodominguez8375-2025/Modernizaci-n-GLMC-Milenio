...
| 22-09-2026 | Ronda de cobertura de tests en módulos críticos y corrección GAP-001 (PRs #126, #127, #128, #130), aprobada por el Product Owner. | Integrados en `dev` (`3ae5ecb5`): tests de Hospitalaria, Ceremonias, Tesorería del Taller, Régimen Interior, Gran Secretaría y Gestor Documental; `frontend/src/ceremonyTypes.ts` como fuente única de tipos de ceremonia (Afiliación e Incorporación ya no se rotulan como Exaltación). CI, demo Pages e instalable QA del mismo SHA en verde; despliegue en `srv01` pendiente (Issue #97). |
| 22-09-2026 | Auditoría de `PMGM-GAP-001` contra código vivo (PR #129) y su corrección. | Resultado corregido: 9 implementados, 2 parciales (GAP-006, GAP-012), 3 abiertos (GAP-005, GAP-009, GAP-013). La primera versión subestimó lo implementado; se deja registro de la corrección en el propio documento. |
