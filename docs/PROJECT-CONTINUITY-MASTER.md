...
| 24-09-2026 | El Product Owner continúa el proyecto después de la conciliación de derechos ceremoniales. | PR #153 integrada en `dev@8522b0dfd3e9db6eb964f6fdce5e8479c2a3525c`; PMGM CI, Showcase/Pages, QA Installable y Pre-UAT post-merge SUCCESS. QA-039 quedó en kit de 39 controles. `main@6dfb9546a4873baff15955cf86abfd7d47e3d111` intacta. El próximo punto del backlog es soporte USD de Perú; se crea propuesta PMGM-ARCH-015 y QA-V071 para no sumar monedas distintas ni inventar conversión. La implementación queda pendiente de decisión de moneda/libro y validación del circuito USD por Gran Tesorería. srv01/UAT siguen diferidos por Issue #97. |
