...
| 24-09-2026 | Showcase de `dev@8522b0d` reveló etiquetas duplicadas en Cuotas y Cobranzas a 1440 px, aunque el móvil se veía legible. | Se corrige la presentación por breakpoint: hasta 900 px se conservan seis etiquetas y seis valores en tarjetas; sobre 900 px se muestran los encabezados de tabla y se ocultan las etiquetas auxiliares. Showcase comprobará ambos modos a 390, 768 y 1440 px. Frontend 196/196, lint y build local pasan; revisión exact-head pendiente por PR. `main` intacta; QA física/UAT siguen pendientes por Issue #97. |
