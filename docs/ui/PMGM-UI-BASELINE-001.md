...
La baseline no es sólo una captura: es la combinación de **SHA Git + fuente visual contractual + evidencia responsive + decisión de UAT**.
...
| SHA de referencia técnica pre-UAT | `46e786ae0ef6a7af200b9c093b9c62107607769f` |
| PMGM CI | #827 · success |
| Showcase | #151 · success |
...
> Este SHA es sólo la referencia técnica que abrió el UAT. Si se agregan correcciones o documentación antes de aprobar, el SHA definitivo aprobado debe reemplazarlo en la sección 3.
...
## 4. Elementos protegidos por la baseline
...
## 7. Relación con la demo y la VM
...
- **Paquete instalable:** debe contener la versión del frontend correspondiente al SHA promovido y no una variante visual distinta.
