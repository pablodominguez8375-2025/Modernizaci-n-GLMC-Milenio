...
La implementación queda en curso en `feature/treasury-reconciliation-audit-20260926`, basada en `dev@85fc5a5816910ae9c477a0aecc1121aca21429b8`. Añade conciliaciones históricas de sólo inserción por rango, con totales calculados en servidor, cantidad de movimientos, saldo contado, diferencia, referencia/nota, sujeto y UTC; cada nuevo conteo conserva el anterior. Se mantiene el límite de 50 registros recientes por rango y se agrega QA-041. La verificación local y los gates exact-head se registrarán al abrir el PR. No se declara QA/UAT aceptada ni se interviene `srv01` o `main`.
