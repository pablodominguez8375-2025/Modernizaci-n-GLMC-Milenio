...
4. `frontend/src/RegimenInteriorPage.tsx`: el panel con personas pendientes/inhabilitadas se titula «Revisión de habilitaciones de Gran Asamblea», con botón de cierre de revisión; el texto explicativo reserva «padrón de la Gran Asamblea» a electores habilitados. Esto no genera ni altera el snapshot electoral definitivo.
...
- Inspeccionar los cuatro archivos de textos en frontend sobre la rama y verificar que «padrón» no identifica membresía o datos maestros.
