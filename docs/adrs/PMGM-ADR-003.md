...
- Para desarrollo local y entornos controlados se permitirá un servicio compatible con S3 ejecutado en contenedores.
...
6. Permite ejecutar el MVP localmente con la misma semántica de almacenamiento utilizada en producción.
...
- Evolución más simple hacia CENDOC, biblioteca y archivo histórico.
...
- Toda versión publicada tendrá hash SHA-256 registrado.
